...
class Order(db.Model):
    ...
    def find_most_popular_items():
        return db.session.execute('SELECT menu_item_id  FROM public."order" GROUP BY menu_item_id HAVING COUNT(menu_item_id)>1 ORDER BY public."order"."count" DESC limit 4')
